package com.karslan.cryptotracker.crypto.presentation.coin_detail
...
import com.karslan.cryptotracker.crypto.presentation.coin_detail.components.InfoCard
...
import com.karslan.cryptotracker.crypto.presentation.models.toDisplayableNumber
    ...
    if (state.isLoading) {
        ...
        Column(
            ...
            FlowRow(
                ...
                val contentColor = if (coin.changePercent24Hr.value < 0.0) {
                ...
                InfoCard(
                    ...
                    icon = if (coin.changePercent24Hr.value < 0) {
